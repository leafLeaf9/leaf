...
public class StreamTest3 {
    ...
    List<Employee> employees = Arrays.asList(new Employee(102, "李四", 59, 6666.66, Status.FREE),
    ...
    */
    ...
    public void test1() {
        ...
        Optional<Employee> optional = employees.stream().sorted((x, y) -> Double.compare(x.getSalary(), y.getSalary()))
                .findFirst();
    ...
    public void test2() {
        ...
        Optional<Double> optional2 = employees.stream().map(/*e -> e.getSalary()*/Employee::getSalary)
                .min(Double::compare);
        System.out.println(optional2.get());
    }
    ...
    public void test4() {
        ...
        HashSet<String> list4 = employees.stream().map(Employee::getName)
    ...
    public void test5() {
        ...
        System.out.println("----------------------------------");
        // 工资总和另一种写法
        Optional<Double> optionalSum = employees.stream().map(Employee::getSalary)
