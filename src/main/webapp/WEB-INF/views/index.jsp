...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <!-- search form (Optional) -->
		<form action="#" class="form-inline ml-3">
			<div class="input-group">
				<input type="text" oninput="searchMenu(this.value)" class="form-control" style="background-color:#374850;" placeholder="菜单搜索">
      ...
      <!-- Sidebar Menu -->
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" id="in-tree">
